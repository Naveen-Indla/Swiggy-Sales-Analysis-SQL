...
## 📌 Project Overview
This project is an **end-to-end SQL data analytics project** built using **Microsoft SQL server Management Studio**.  
...
- **Database:** MySQL  
- **SQL IDE:** Microsoft SQL Server Management Studio  
- **Data Source:** CSV file , Excel File
